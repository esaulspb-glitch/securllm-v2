...
st.title("🏦 SecurLLM")
st.markdown("""
    *SecurLLM — система на основе LLM (GigaChat) для проектирования, оптимизации и управления 
    системами безопасности и противопожарной защиты объектов банка на всех этапах жизненного цикла.*
""")
